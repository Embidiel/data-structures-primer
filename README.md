...
Pero in reality ang Graph ay ***isa lamang collection of nodes na pwedeng magkaka-connect or hindi sa isat isa.***

Sa Linked List, ***`Nodes`*** yung term na ginagamit pero sa isang Graph.
***`Vertex`*** or Vertices ang tawag sa isang node. 

Tapos yung ***connection between sa nodes*** naman ay 
`Edges`.

***Maraming types ng Graphs pero ang importante lang is malaman natin yung key concepts or things na properties kapag nakikita natin ang Graph.***

Kung makikita niyo na yung ***Vertex 6 at Vertex 3 ay hindi connected sa ibang mga vertices sa Graph.***

Etong graph na to ay ***`Disconnected Graph`.***

In real life pwede yung vertices ay locations sa isang bansa tapos yung edges ay parang transportation channels. 

***Yung vertex 3 pwede nating sabihin na space base siya na di siya accessible sa public transportation channels at yung vertex 6 naman pwedeng moon kung example.***
...
***Kung galing ka ng Vertex 1 pwede ka pumunta ng Vertex 2 pero kung galing ka ng Vertex 2 di ka pwede sa Vertex 1.***
    ...
    Vertex 1 -> Vertex 2 (Possible)
    Vertex 2 <- Vertex 1 (Wrong)

***Real world example is kunwari yung bahay niyo si Vertex 1 tapos Vertex 2 is SM North tapos yung edge one way na daanan lang para sa mga sasakyan haha.***

Pag ***`Undirected Graph`*** naman ***pwedeng two way tapos walang arrow yung edge.***

Example sa ***Facebook***. 

***Ikaw si Vertex 1 tapos friend mo si IU na Vertex 2 kapag friends kayo ibig sabihin may two way relationship or walang arrow yung edge.***

Isa pang concept sa Graph Theory ay yung `Cycles`. 

Kapag sinearch mo kay Google mejo complicated lalabas.
...
Tapos yung another page (2) pwedeng mag link or magreference sa una mong binisita haha.
    ...
    IU Wikipedia page -> Love Poem Album -> Blueming song -> IU Wikipedia page
...
***Tapos every node / key nag iistore ng list ng mga edges or adjacency.***
